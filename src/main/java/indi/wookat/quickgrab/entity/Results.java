...
implements Serializable {
    ...
    public String toString() {
        return "Results(id=" + this.getId() + ", deviceId=" + this.getDeviceId() + ", buyerId=" + this.getBuyerId() + ", threadId=" + this.getThreadId() + ", link=" + this.getLink() + ", cookies=" + this.getCookies() + ", orderInfo=" + this.getOrderInfo() + ", userInfo=" + this.getUserInfo() + ", orderTemplate=" + this.getOrderTemplate() + ", message=" + this.getMessage() + ", idNumber=" + this.getIdNumber() + ", keyword=" + this.getKeyword() + ", startTime=" + this.getStartTime() + ", endTime=" + this.getEndTime() + ", quantity=" + this.getQuantity() + ", delay=" + this.getDelay() + ", frequency=" + this.getFrequency() + ", type=" + this.getType() + ", status=" + this.getStatus() + ", responseMessage=" + this.getResponseMessage() + ", actualEarnings=" + this.getActualEarnings() + ", estimatedEarnings=" + this.getEstimatedEarnings() + ", extension=" + this.getExtension() + ")";
    }
}
